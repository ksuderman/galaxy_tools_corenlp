...
The tests require the Stanford CoreNLP English language models AND common models JAR. Download them before running tests:

```bash
cd test-data
# Download English language models (424MB)
...
# Download common models JAR for coreference resolution (452MB)  
curl -L -o stanford-corenlp-4.5.10-models.jar \
  https://repo1.maven.org/maven2/edu/stanford/nlp/stanford-corenlp/4.5.10/stanford-corenlp-4.5.10-models.jar
```
